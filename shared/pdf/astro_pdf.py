"""
shared/pdf/astro_pdf.py
================================
General-purpose premium PDF builder for all Astro Suite features.

Replaces shared.astro/pdf_builder.py entirely.
...
# shared.astro/pdf_builder.py previously exported generate_premium_pdf().
...
def generate_premium_pdf(report_text: str, diagnostic_pil, user_name: str) -> bytes:
    """
    Backwards-compatible wrapper for the old shared.astro/pdf_builder.generate_premium_pdf().
