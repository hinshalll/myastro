"""
shared.pdf/generate_theme_assets.py — one-shot AI image generator.

Generates the 12 deity images (6 themes × cover + watermark) and saves
them to shared.pdf/static/themes/<theme>/cover.png and watermark.png.
...
Usage
-----
    python -m shared.pdf.generate_theme_assets [--theme NAME] [--force]
    python -m shared.pdf.generate_theme_assets --theme ganesha
    python -m shared.pdf.generate_theme_assets --force  # regenerate all
