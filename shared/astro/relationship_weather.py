...
_RASHI_FLAVOUR: dict[int, dict] = {
    0: {"key": "mirror", "base": 0.62,
        "bond": "You two feel things on the same wavelength — when one of you lifts, so does the other; when one dips, it tends to echo.",
        "lean": "moving through the day in sync",
        "watch": "quietly feeding each other's low moods"},
    1: {"key": "give_take", "base": 0.56,
        "bond": "There's a natural give-and-take here — one of you tends to give and look after, the other to lean in and receive.",
        "lean": "small acts of care passing back and forth",
        "watch": "letting it quietly become one-sided"},
    2: {"key": "easy", "base": 0.70,
        "bond": "You're easy company — things just tend to stay uncomplicated between you.",
        "lean": "low-effort, relaxed time together",
        "watch": "taking the easiness for granted"},
    3: {"key": "respectful", "base": 0.58,
        "bond": "You connect through respect and practical care more than open emotion — doing beats discussing, and that's genuinely fine.",
        "lean": "doing something useful side by side",
        "watch": "expecting big emotional outpourings"},
    4: {"key": "warm", "base": 0.74,
        "bond": "There's a real fondness here — warmth and affection come easily, almost without trying.",
        "lean": "open, warm-hearted conversation",
        "watch": "assuming it'll always be this effortless"},
    5: {"key": "friction", "base": 0.42,
        "bond": "You two can rub each other the wrong way if you're not paying attention — this is a bond that rewards a little extra patience.",
        "lean": "small kindnesses and a softer tone",
        "watch": "letting little irritations stack up"},
    6: {"key": "opposites", "base": 0.60,
        "bond": "You're opposites who somehow fit — different enough to cover each other's blind spots.",
        "lean": "letting your differences fill each other's gaps",
...
_DAY: dict[str, dict] = {
    "easy":   {"word": "Easy",   "dscore": 0.88,
               "clause": "The mood between you flows easily today — a genuinely lovely day to connect.",
               "good": "heart-to-hearts, making plans, or smoothing over anything left hanging",
               "avoid": "overthinking it — today's on your side"},
    "light":  {"word": "Light",  "dscore": 0.72,
               "clause": "Today's light and friendly between you — easy to just enjoy each other.",
               "good": "a relaxed catch-up and small, kind gestures",
               "avoid": "forcing a big or heavy talk"},
    "steady": {"word": "Steady", "dscore": 0.58,
               "clause": "Steady and ordinary between you today — nothing to push, nothing to fix.",
               "good": "everyday, practical time together",
               "avoid": "expecting a deep emotional breakthrough"},
    "uneven": {"word": "Uneven", "dscore": 0.47,
               "clause": "The energy's a little uneven today — one of you may be brighter than the other, so go gently.",
               "good": "patience, and meeting them where they actually are",
               "avoid": "taking a flat or quiet mood personally"},
    "careful": {"word": "Careful", "dscore": 0.39,
               "clause": "Today asks for a bit of care — keep it light and don't force anything heavy.",
               "good": "keeping things low-pressure and easy",
               "avoid": "big decisions or touchy subjects"},
    "tender": {"word": "Tender", "dscore": 0.30,
               "clause": "Today feels tender between you — kindness and patience will go further than anything clever.",
               "good": "gentleness, a little space, and small comforts",
               "avoid": "pushing, criticism, or hard conversations"},
}
