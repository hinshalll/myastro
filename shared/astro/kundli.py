"""
shared.astro/kundli — Premium Kundli backend (all modules consolidated)
======================================================================
...
__all__ = [
    ...
    # Universal chart rendering (proxies into shared.pdf for ergonomic single-import)
    "render_chart_svg",
]
...
def compute_chart(bd: BirthData) -> KundliChart:
    ...
    try:
        from shared.astro.kundli_text import compute_interpretations
