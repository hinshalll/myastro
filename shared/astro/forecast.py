...
_CHANDRA_HOUSE: dict[int, dict] = {
    1:  {"vibe": "Settled",   "theme": "steady and self-contained", "base": 0.62,
         ...
         "opportunity": "A good day to move at your own pace and look after yourself, no apology needed.",
         "caution": "It's easy to vanish into your own head today, so surface for air and check in with someone.",
         "action": "Do one small thing purely because it's good for you."},
    2:  {"vibe": "Guarded",   "theme": "focused on money, home and words", "base": 0.42,
         "mood": "Your mind keeps circling money, home, and your closest people, and feelings sit a little tight.",
         "opportunity": "Slow and careful wins today. Sort one money or family thing properly, not boldly.",
         "caution": "Words land heavier than you mean them to right now, and spending turns reactive, so go easy on both.",
    ...
    3:  {"vibe": "Bold",      "theme": "courageous and outgoing", "base": 0.72,
         "mood": "Courage is up and you want things moving. Reaching out, speaking up, making the first move.",
         "opportunity": "Great for conversations, quick trips, and finally starting the thing you've been circling.",
         "caution": "All this momentum scatters easily, so aim it at one or two things, not ten.",
    ...
    4:  {"vibe": "Tender",    "theme": "homeward and soft-hearted", "base": 0.44,
         ...
         "caution": "A wistful, low mood might drift in. That's the day talking, not you, so let it pass.",
    ...
    5:  {"vibe": "Restless",  "theme": "stimulation-seeking and a touch unsettled", "base": 0.40,
         "mood": "Part of you wants play, romance, a little attention, with a restless flicker running underneath.",
         "opportunity": "Fine for light creativity and fun, as long as you keep the stakes low.",
         "caution": "Not your steadiest day, so skip the big gamble and don't go chasing applause.",
    ...
    6:  {"vibe": "Capable",   "theme": "productive and good at clearing problems", "base": 0.66,
         ...
         "caution": "That problem-hunting sharpness can tip into picking fights, so keep it aimed at tasks, not people.",
    ...
    8:  {"vibe": "Deep",      "theme": "deep, inward and a little heavy", "base": 0.32,
         ...
         "caution": "Worry can lie to you today, so steer clear of big risks, confrontations, and 3am decisions.",
    ...
    11: {"vibe": "Upbeat",    "theme": "hopeful, social and in flow", "base": 0.84,
         "mood": "Optimism's up and you feel more social, more supported, and more in flow than usual.",
    ...
    12: {"vibe": "Quiet",     "theme": "quiet, inward and restorative", "base": 0.36,
         "mood": "Energy turns inward today, and you might feel dreamy, tired, or quietly withdrawn.",
         "opportunity": "Made for rest, winding down, and letting go of something you've outgrown.",
         "caution": "Not a day to force decisions or cram the calendar, so watch your energy and your wallet.",
