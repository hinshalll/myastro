...
YOGA_WARM: dict[str, dict] = {
    "Gajakesari": {"body": "There's a quiet blessing in how you carry yourself — good judgement, goodwill, and a way of earning people's trust without trying. Wisdom tends to find you, and others sense it.",
                   "sanskrit": "गजकेसरी योग (चन्द्र-गुरु)"},
    "Budha-Aditya": {"body": "Your mind is one of your real strengths — you learn fast and explain things in a way that just lands. People underestimate how sharp you are until they see it.",
                     "sanskrit": "बुध-आदित्य योग"},
    "Ruchaka": {"body": "You carry a presence people feel when you walk in — courage, drive, and a natural way of getting others to follow your lead.",
                "sanskrit": "रुचक महापुरुष योग (मंगल)"},
    "Bhadra": {"body": "There's a real sharpness to your mind — you think clearly and say things well, and you're at your best when you're learning or figuring something out.",
               "sanskrit": "भद्र महापुरुष योग (बुध)"},
    "Hamsa": {"body": "People sense a kind of decency in you — principled, fair, quietly wise — and they tend to respect you for it before you've even said much.",
              "sanskrit": "हंस महापुरुष योग (गुरु)"},
    "Malavya": {"body": "There's a charm and an eye for beauty in you that draws good things closer — comfort, grace, and people who want you around.",
                "sanskrit": "मालव्य महापुरुष योग (शुक्र)"},
    "Shasha": {"body": "You've got real staying power — the patience to build things that last and the quiet authority that comes from earning your place rather than being handed it.",
